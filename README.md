...
**DEMO**: [https://github.com/yukapril/camera-h5-demo](https://github.com/yukapril/camera-h5-demo)  
...
* `offsetRatio` 容差范围，默认 `0.05`，数值越大，最终图片与 `maxSize` 差距越大。
...
### Camera.rotate(base64, direction, callback)
...
`direction` 图片旋转方向，支持 `0` `90` `180` `270` `360`。
